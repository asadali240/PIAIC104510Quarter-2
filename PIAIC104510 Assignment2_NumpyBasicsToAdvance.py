...
def function1():
    ...
    x = np.arange(1,12+1).reshape(6,2)
...
def function2():
    ...
    x = x = np.arange(10,36+1).reshape(3,3,3)
...
def function6():
    ...
    arr = np.zeros(10, dtype =np.int )#wrtie your code here
    arr[4] = 10
    arr[7] = 20
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = subt = arr - np.vstack(brr)  # write your code here 
